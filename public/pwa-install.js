...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  .pwa-ios-modal { padding: 16px 16px; padding-bottom: calc(16px + env(safe-area-inset-bottom, 0px)); }',
      '  .pwa-ios-modal h3 { font-size: 16px; margin-bottom: 12px; }',
      '  .pwa-ios-steps { margin-bottom: 16px; }',
      '  .pwa-ios-steps li { padding: 8px 0; font-size: 14px; }',
      '  .pwa-ios-step-num { width: 24px; height: 24px; font-size: 12px; }',
      '  .pwa-ios-ok-btn { padding: 10px; font-size: 14px; }',
      '  .pwa-ios-dismiss-link { margin-top: 8px; }',
      '}',
    ].join('\n');
